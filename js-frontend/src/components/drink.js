...
class Drink {
  ...
  renderLi() {
    return `<div class="single-drink"><h4><li data-id=${this.id} class="li-drink-name">${this.name}</li></h4> <p data-id=${this.id} class="p-drink-description">${this.description}</p></div>`;
  }
}
